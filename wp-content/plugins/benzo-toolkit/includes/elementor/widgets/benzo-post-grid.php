...
class Benzo_Post_Grid extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Benzo Post Grid', 'benzo-toolkit' );
    }
    ...
    public function get_keywords() {
        return ['Benzo', 'post', 'news', 'grid', 'blog'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .benzo-post-boxes' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .benzo-post-boxes' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'wrapper_border',
                'selector' => '{{WRAPPER}} .benzo-post-boxes',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .benzo-post-boxes' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .benzo-post-box .post-content .post-meta .post-categories::before' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'meta_design' => 'meta-design-three',
                ],
    ...
    protected function render() {
        ...
        Benzo_Post_Templates::render_post_boxes( $settings );
    }
}
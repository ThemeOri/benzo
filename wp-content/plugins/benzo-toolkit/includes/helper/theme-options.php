        ...
        CSF::createSection( $this->options_prefix, [
            ...
            'fields' => [
                ...
                [
                    ...
                    'default'  => '#fb2614',
                    'subtitle' => esc_html__( 'Default: #fb2614', 'benzo-toolkit' ),
                ],
                [
                    'id'       => 'secondary_color',
                    'type'     => 'color',
                    ...
                    'default'  => '#000000',
                    'subtitle' => esc_html__( 'Default: #000000', 'benzo-toolkit' ),
                ],
                [
                    'id'       => 'body_color',
                    'type'     => 'color',
                    ...
                    'default'  => '#636465',
                    'subtitle' => esc_html__( 'Default: #636465', 'benzo-toolkit' ),
                ],
                [
                    'id'       => 'border_color',
                    'type'     => 'color',
                    ...
                    'default'  => '#eaeaea',
                    'subtitle' => esc_html__( 'Default: #eaeaea', 'benzo-toolkit' ),
                ],
                [
                    'id'       => 'light_color',
                    'type'     => 'color',

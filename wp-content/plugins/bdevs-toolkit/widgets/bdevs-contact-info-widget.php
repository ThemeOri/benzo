...
class Kingfact_Contact_Info_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct( 'kingfact_contact_info_widget', esc_html__( 'Wetland Contact Info', 'bdevs-toolkit' ), [
            'description' => esc_html__( 'Wetland Contact Info Widget', 'bdevs-toolkit' ),
        ] );
    }

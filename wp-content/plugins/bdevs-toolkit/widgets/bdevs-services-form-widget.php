...
class bdevs_services_form_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct( 'bdevs_services_form_widget', esc_html__( 'Eduman Services Form', 'bdevs-toolkit' ), [
            'description' => esc_html__( 'Eduman Services Form Widget', 'bdevs-toolkit' ),
        ] );
    }

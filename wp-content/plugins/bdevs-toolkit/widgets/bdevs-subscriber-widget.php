<?php
    ...
    class Bdevs_Subscriber_Widget  extends WP_Widget{
        ...
        public function __construct(){
            parent::__construct('bdevs_subscriber_widget',esc_html__('Wetland Subscriber','bdevs-toolkit'),array(
                'description' => esc_html__('Wetland Subscriber Widget','bdevs-toolkit'),
            ));
        }

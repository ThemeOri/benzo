    ...
    protected function video_info_content_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('https://www.youtube.com/watch?v=eWRfhZUzrAc', 'generic-elements'),
    ...
    protected function video_info_content_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .generic-el-video-popup.popup-video' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .generic-el-video-popup.popup-video' => 'min-height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .popup-video' => 'line-height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12">
                        <div class="generic-el-video-wrapper">
                            <a class="generic-el-video-popup popup-video" href="<?php echo esc_url($settings['video_url']); ?>">

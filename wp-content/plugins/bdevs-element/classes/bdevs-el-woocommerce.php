...
class BDevs_El_Woocommerce
{
    ...
    public static function add_to_cart_button($product_id)
    {
        if (BDEVSEL_WOOCOMMERCE_ACTIVED) {
            ...
            if ($product) {
                ...
                return sprintf('<a rel="nofollow" data-toggle="tooltip" data-placement="top" title="Shoppingb Cart" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s add_to_cart_button p-cart action_cart_btn">Add to Cart</a>',
    ...
    public static function product_rating($product_id)
    {
        ...
        $html = '';
        $html .= '<ul class="reting_star ul_li_center" title="' . $review . '">';

        for ($i = 0; $i <= 4; $i++) {

            if ($i < floor($rating)) {
                $html .= '<li class="active"><i class="flaticon-star"></i></li>';
            } else {
                $html .= '<li><i class="flaticon-star"></i></li>';
            }
        }
    ...
    public static function product_rating_grid2($product_id)
    {
        ...
        $html = '';
        $html .= '<ul class="reting_star ul_li" title="' . $review . '">';

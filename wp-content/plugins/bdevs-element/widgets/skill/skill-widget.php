...
class Skill extends BDevs_El_Widget {
    ...
    public function get_title() {
        return __( 'Our Skill', 'bdevs-element' );
    }
    ...
    protected function register_content_controls() {
        ...
        $repeater->add_control(
            'active_skill_color',
            [
                'label' => __( 'Active Skill Color', 'bdevs-element' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#d42222',
                'selectors' => [
                    '{{WRAPPER}} .progress_item .progress_bar' => 'background-color: {{VALUE}}'
                ]
            ]
        ); 
        ...
        $repeater->add_control(
            'skill_color',
            [
                'label' => __( 'Skill Color', 'bdevs-element' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#FFECEC',
                'selectors' => [
                    '{{WRAPPER}} .progress_item .progress' => 'background-color: {{VALUE}}'
                ]
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'label' => __( 'Skill Number', 'bdevs-element' ),
                'default' => __( '80', 'bdevs-element' ),
	...
	protected function render() {
        ...
        <section class="skill_section sec_ptb_130 clearfix">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 wow fadeInUp22" data-wow-delay=".1s">
        ...
        <div class="progress_bar_area">
            ...
            <div class="progress_item">
                <?php if ( !empty( $slide['title'] ) ) : ?>
                  <h4 class="item_title mb-0"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></h4>
                <?php endif; ?>
              <div class="progress">
                <?php if(!empty($slide['number'])) : ?>
                <div class="progress_bar wow Rx_width_<?php echo esc_html( $slide['number'] ); ?>" role="progressbar" data-wow-duration="1s"
                  data-wow-delay=".4s" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                  <span class="value_text"><?php echo esc_html( $slide['number'] ); ?>%</span>
                </div>
                <?php endif; ?>
              </div>
            </div>

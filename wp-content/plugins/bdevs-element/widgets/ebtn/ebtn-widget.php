...
class EBtn extends BDevs_El_Widget
{
    ...
    protected function render()
    {
        ...
        if (!empty($settings['button_link'])) {
            $this->add_render_attribute('button', 'class', 'bdves-btn');
        ...
        <div class="brand__more m-0">
            <a href="<?php echo esc_url($settings['button_link']['url']); ?>" class="link-btn">
    ...
    <?php else:
        if (!empty($settings['button_link'])) {
            $this->add_render_attribute('button', 'class', 'e-btn e-btn-border e-btn-5');
            $this->add_link_attributes('button', $settings['button_link']);
        }

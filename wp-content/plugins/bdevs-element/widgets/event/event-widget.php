...
class Event extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->start_controls_section(
            '_section_title',
            [
                'label' => __( 'Heading', 'bdevs-element' ),
                'tab' => Controls_Manager::TAB_CONTENT,
                'condition' => [
                    'design_style' => 'style_20'
                ],
        ...
        $this->start_controls_section(
            '_section_icon',
            [
                'label' => __( 'Event List', 'bdevs-element' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __( 'Event Title', 'bdevs-element' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __( 'Event sub Title', 'bdevs-element' ),
                'placeholder' => __( 'Type Icon Box sub Title', 'bdevs-element' ),
                'condition' => [
                    'field_condition' => ['style_20'],
                ], 
                'dynamic' => [
        ...
        $repeater->add_control(
            'event_meta',
            [
                'label' => __( 'Event Meta', 'bdevs-element' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'placeholder' => __( 'Event Meta Here', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
    ...
    protected function render() {
               ...
               <div class="row">
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="category__item mb-30 transition-3 d-flex align-items-center">
                            <?php if( $slide['svg_icon'] ): ?>
                            <div class="category__icon mr-30">
                                <?php echo  $slide['svg_icon']; ?>
                            </div>
                            <?php endif; ?>

                            <div class="category__content bdevs-el-content">
                            <?php if( $slide['title'] ) : ?>
                                <h4 class="category__title bdevs-el-title"><a href="<?php echo esc_url( $slide['s_url'] ); ?>"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></a></h4>
                            <?php endif; ?>
        ...
        <section class="events__area p-relative">
            <?php if ( !empty($settings['shape_switch']) ): ?>
            <div class="events__shape">
               <img class="events-1-shape" src="<?php print get_template_directory_uri(); ?>/assets/img/events/events-shape.png" alt="img">
            </div>
            <?php endif; ?>
                        ...
                        <div class="events__item mb-10 hover__active">
                            <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                                ...
                                <div class="events__content">
                                    <?php if( $slide['event_meta'] ): ?>
                                    <div class="events__meta">
                                        <?php echo bdevs_element_kses_intermediate( $slide['event_meta'] ); ?>
                                    </div>
                                    <?php endif; ?>
                                    <?php if( $slide['title'] ) : ?>
                                        <h3 class="events__title bdevs-el-title"><a href="<?php echo esc_url( $slide['s_url'] ); ?>"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></a></h3>
                                    <?php endif; ?>
                                </div>
                                <div class="events__more">
                                    <?php if ( $slide['button_text'] ): ?>
                                    <a href="<?php echo esc_url( $slide['s_url'] ); ?>" class="link-btn bdevs-el-btn">
                                        <?php echo bdevs_element_kses_intermediate( $slide['button_text'] ); ?>

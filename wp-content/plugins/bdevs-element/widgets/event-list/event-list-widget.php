...
class Event_List extends BDevs_El_Widget
{
    ...
    {
        return __('Event List', 'bdevs-element');
    }
            ...
            <div class="container">
               <div class="row">
                    <?php foreach ($posts as $inx => $post):
                       ...
                       $time_text = function_exists('get_field') ? get_field('time_text',$post->ID) : '';
                     ...
                     <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                           ...
                           <div class="events__more">
                              ...
                              <a href="<?php echo esc_url(get_the_permalink($post->ID)); ?>" class="link-btn">
                              <?php print esc_html($settings[$selected_post_type][$inx]['list_btn_text']) ; ?>

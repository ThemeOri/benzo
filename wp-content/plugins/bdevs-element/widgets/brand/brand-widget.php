...
class Brand extends BDevs_El_Widget {
    ...
    protected function render() {
            ...
            <div class="footer_brand_area border_bottom clearfix">
                <div class="row align-items-center justify-content-lg-between">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="brand_slide owl-carousel" data-controls="<?php echo esc_attr($slide_controls); ?>">
                            <?php 
        ...
        ?>
            ...
            <div class="brand_section_2 d-none">
                <div class="container">
                    <div class="footer_brand_area border_bottom clearfix p-0">
                        <div class="row align-items-center">
                            <div class="col-lg-12 col-md-8 col-sm-12 col-xs-12">
                                <div class="brand__slider owl-carousel brand-nav-style brand-dot-style" data-controls="<?php echo esc_attr($slide_controls); ?>">
                                    <?php 
                                        foreach ( $settings['slides'] as $slide ) :
                                        $image = wp_get_attachment_image_url( $slide['image']['id'], $settings['thumbnail_size'] );
                                        if ( ! $image ) {
                    ...
                    <div class="col col-lg-7">
                      <div class="client_wrap">
                        ...
                        <?php 
                          ...
                          ?>
                          <li><a href="<?php echo esc_url( $slide['slide_url'] ); ?>"><img src="<?php print esc_url($image); ?>"></a></li>
                          <?php endforeach; ?>
                        </ul>
                      </div>
                    </div>

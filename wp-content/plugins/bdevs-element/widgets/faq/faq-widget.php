...
class FAQ extends BDevs_El_Widget
{
    ...
    protected function register_content_controls()
    {
        ...
        $this->add_control(
            'faq_image',
            [
                'label' => __('FAQ Image', 'bdevs-element'),
    ...
    protected function render()
    {
        ...
        <div class="faq_accordion_wrap" id="faq_accordion">
            ...
            <div class="accordion_item">
                <div class="accordion_header" id="heading_one_<?php echo esc_attr($id); ?>">
                    <h3 class="accordion_button <?php echo esc_attr($collapsed_tab); ?>"
                    data-bs-toggle="collapse" 
                    data-bs-target="#collapse_one_<?php echo esc_attr($id); ?>"
                    aria-expanded="<?php echo esc_attr($area_expanded); ?>" 
                    aria-controls="collapse_one_<?php echo esc_attr($id); ?>">
                      <?php echo bdevs_element_kses_basic($slide['tab_title']); ?>
                    </h3>
                </div>
                <div id="collapse_one_<?php echo esc_attr($id); ?>" 
                    class="accordion_collapse collapse <?php echo esc_attr($active_show_tab); ?>" 
                    aria-labelledby="heading_one_<?php echo esc_attr($id); ?>"
    ...
    <?php else: 
        ...
        if ( !empty($settings['faq_image']['id']) ){
            $faq_image = wp_get_attachment_image_url( $settings['faq_image']['id'], $settings['bg_thumbnail_size'] );
        }
    ?>
    <section class="faq_details">
        <div class="container">
            <div class="row">
                <div class="col order-last col-lg-6 col-md-8">
                    <?php if (!empty($faq_image)) : ?>
                    <div class="faq_image">
                        <img src="<?php print esc_url($faq_image); ?>" alt="Question Image">
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="col col-lg-6">
                  ...
                  <div class="faq_accordion_2" id="faq_accordion">
                    <?php foreach ($settings['slides'] as $id => $slide) :
                        // active class
                        $collapsed_tab = ($id == 0) ? '' : 'collapsed';
                        $area_expanded = ($id == 0) ? 'true' : 'false';
                    ...
                    ?>
                    <div class="accordion_item">
                        <div class="accordion_header" id="heading_1_<?php echo esc_attr($id); ?>">
                            <button class="accordion_button <?php echo esc_attr($collapsed_tab); ?>" 
                                type="button" 
                                data-bs-toggle="collapse"
                                data-bs-target="#collapse_1_<?php echo esc_attr($id); ?>" 
                                aria-expanded="<?php echo esc_attr($area_expanded); ?>" 
                                aria-controls="collapse_1_<?php echo esc_attr($id); ?>">
                              <?php echo bdevs_element_kses_basic($slide['tab_title']); ?>
                            </button>
                        </div>
                        <div id="collapse_1_<?php echo esc_attr($id); ?>" 
                            class="accordion_collapse collapse <?php echo esc_attr($active_show_tab); ?>" 
                            aria-labelledby="heading_1_<?php echo esc_attr($id); ?>"
                            data-bs-parent="#faq_accordion">
                            <div class="accordion_body">
                              <p class="mb-0">
                                <?php echo bdevs_element_kses_basic($slide['tab_content_info']); ?>

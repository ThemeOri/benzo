    ...
    protected function register_content_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Hero Description', 'bdevs-element' ),
                'placeholder' => __( 'Type Hero Description Here', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            'nav_overlay_color',
            [
                'label' => __( 'Nav Overlay Color', 'bdevs-element' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'show_label' => true,
                'label' => __( 'Nav Sub Title', 'bdevs-element' ),
                'default' => __( 'Subtitle', 'bdevs-element' ),
                'placeholder' => __( 'Type Nav Subtitle Here', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'label' => __( 'Nav Title', 'bdevs-element' ),
                'default' => __( 'Nav Title Here', 'bdevs-element' ),
                'placeholder' => __( 'Type Nav title here', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]

...
class Subscribe extends BDevs_El_Widget {
    ...
    public function get_title() {
        return __( 'Subscribe', 'bdevs-element' );
    }
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Type big title here', 'bdevs-element' ),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => bdevs_element_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'bdevs subtitle here', 'bdevs-element' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Mailchimp', 'bdevs-element' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'mailchimp_shortcode',
            [
                'label' => __( 'Mailchimp Shortcode', 'bdevs-element' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'description' => __( 'Add Mailchimp Shortcode.', 'bdevs-element' ),
            ]
        );
            ...
            <div class="container">
              <div class="row align-items-center justify-content-lg-between">
                <div class="col col-lg-4">
                  <div class="title_wrap bdevs-el-content">

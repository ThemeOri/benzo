...
class Heading extends BDevs_El_Widget
{
    ...
    {
        return __('Heading', 'bdevs-element');
    }
    ...
    protected function render()
    {
        ...
        <h2 class="sub_title bdevs-el-subtitle">
            ...
            <?php endif;?>
            <?php if ($settings['shape_title'] && $settings['shape_switcher']) : ?>
                <span class="under_text"><?php echo bdevs_element_kses_intermediate($settings['shape_title']); ?></span>
            <?php endif;?>
        </h2>

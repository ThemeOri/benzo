	...
	*/
	...
	public function init_widgets() {
    	...
    	if (  function_exists('tutor') ) {
	        // Include Widget files
			$_widget_list = BdevsElement\Helper::get_tutor_course_widgets();
			foreach ( $_widget_list as $widget_key => $data ) {
	            self::register_widget( $widget_key );
	        }
    	}
    	...
    	if (  class_exists( 'LearnPress' ) ) {
	        // Include Widget files
			$_widget_list = BdevsElement\Helper::get_learnpress_course_widgets();
			foreach ( $_widget_list as $widget_key => $data ) {
	            self::register_widget( $widget_key );
	        }
    	}
    	...
    	if (  class_exists( 'SFWD_LMS' ) ) {
	        // Include Widget files
			$_widget_list = BdevsElement\Helper::get_learndash_course_widgets();
			foreach ( $_widget_list as $widget_key => $data ) {
	            self::register_widget( $widget_key );
	        }
    	}
